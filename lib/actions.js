...
function uploadFiles(identificator, url, files, type, data, headers) {
  var concurrency = arguments.length > 6 && arguments[6] !== undefined ? arguments[6] : 2;
  ...
  return function (params) {
    ...
    var uploadFilePromise = _bluebird2.default.map(files, function (file) {
      return uploadFile(dispatch, url, identificator, file, data, headers);
