  ...
  (0, _createClass3.default)(FileUpload, [{
    ...
    value: function () {
      var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(event) {
        var _props, addUploadingDocs, addUploadingImages, allowedFileTypes, headers, data, dropzoneId, identifier, uploadFiles, url, dragCount, allowedFiles, imageFiles, docFiles, id;

        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _props = this.props, addUploadingDocs = _props.addUploadingDocs, addUploadingImages = _props.addUploadingImages, allowedFileTypes = _props.allowedFileTypes, headers = _props.headers, data = _props.data, dropzoneId = _props.dropzoneId, identifier = _props.identifier, uploadFiles = _props.uploadFiles, url = _props.url;
